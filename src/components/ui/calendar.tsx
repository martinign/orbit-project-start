  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "!bg-transparent text-foreground border-2 border-blue-500 hover:bg-blue-50 hover:text-foreground focus:bg-blue-50 focus:text-foreground",
      ...
      components={{
        ...
        DayContent: props.components?.DayContent || undefined,
      }}
      {...props}
    />
  );
