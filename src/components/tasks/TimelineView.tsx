...
export const TimelineView: React.FC<TimelineViewProps> = ({ tasks, isLoading }) => {
  ...
  // (Optional) measure longest title for list min-width
  ...
  useEffect(() => {
    ...
    try {
      ...
      setMonths(Object.entries(m).map(([month, cnt]) => ({ month, days: cnt })));
    } catch (err) {
      console.error(err);
      toast({
      ...
      <ResizablePanelGroup direction="horizontal" className="h-full">
        ...
        <ResizablePanel defaultSize={85} className="min-w-0">
          <div className="flex flex-col h-full">
            {/* Everything below scrolls horizontally in sync */}
              ...
              >
                ...
                <div className="sticky top-0 bg-background z-10">
                  ...
                  <div className="flex h-8 border-b">
                    {days.map((day, i) => (
                      <div
                        key={i}
                        className={`w-[30px] flex-none flex items-center justify-center text-[10px] border-r ${
                ...
                <div className="relative divide-y">
                  ...
                  <div
                    ...
                    style={{
                      left: `${days.findIndex(d => isToday(d)) * 30}px`,
                    }}
                  />
                </div>
              </div>
