...
export const TimelineView: React.FC<TimelineViewProps> = ({
  ...
  // You can choose px-per-day or %; here is px-based for readability:
  ...
  return (
    <div className="border rounded-md h-full overflow-hidden">
      <ResizablePanelGroup direction="horizontal" className="h-full">
        ...
        {/* Right: Entire Timeline */}
        <ResizablePanel defaultSize={85} className="min-w-0 overflow-hidden">
          <div className="flex flex-col h-full">
            {/* ← Parent scrollable container for everything in yellow */}
            <ScrollArea orientation="horizontal" className="flex-1">
              ...
              {/* Horizontal ScrollBar inside the same parent */}
