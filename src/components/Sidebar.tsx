                  ...
                  e.preventDefault();
                    ...
                    <SidebarMenuAction showOnHover>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="w-40" data-dropdown="true">
                          <DropdownMenuItem onClick={e => handleEditProject(e, project)} data-action="true">
                            Edit
                          </DropdownMenuItem>
                          <DropdownMenuItem className="text-red-600" onClick={e => handleDeleteProject(e, project)} data-action="true">
                            Delete
                          </DropdownMenuItem>
                        </DropdownMenuContent>
                      </DropdownMenu>
