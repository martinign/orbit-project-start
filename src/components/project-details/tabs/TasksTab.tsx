  ...
  return <Card>
      ...
      <CardContent>
        {tasksLoading ? <div className="text-center py-6 border rounded-lg bg-gray-50">
          ...
          </div> : tasks && tasks.length > 0 ? !isTimelineView ? <TaskBoard tasks={tasks} projectId={projectId} onRefetch={refetchTasks} /> : <TimelineView tasks={tasks} isLoading={tasksLoading} /> : <div className="text-center p-8 border rounded-lg bg-gray-50">
